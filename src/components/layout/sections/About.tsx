...
export default function About() {
  return (
    <Section>
      <Title>About</Title>
      <P>Hello my name is Wilson, passionate for what I do and committed to delivering the best result, experience in front-end and back-end, allowing me to work on various fronts in Software Development field.</P>
