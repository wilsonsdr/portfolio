...
export default function Carousel() {
  ...
  return (
    <div className="flex flex-col relative w-10/12 h-[270px] mt-4 p-4 bg-[#222] rounded-sm">
      ...
      <Slider {...settings}>
        <div className="relative">
          <div className="absolute opacity-0 top-0 left-0 w-full h-full hover:opacity-90 hover:bg-black transition-all duration-500">
            <div className="absolute flex flex-col gap-4 text-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 font-p">
              <h1 className="text-2xl max-md:text-xl">Pizzaria Donna</h1>
              <span className="max-md:hidden">
                Landing Page com design de pizzaria, mas na realidade é um canal
                de denúncia contra a violência doméstica
              </span>
              <a
                className="p-1 bg-[#222] block rounded-full hover:bg-[#333] max-md:text-xs"
        ...
        <div className="relative">
          <div className="absolute opacity-0 top-0 left-0 w-full h-full hover:opacity-90 hover:bg-black transition-all duration-500">
            <div className="absolute flex flex-col gap-4 text-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 font-p">
              <h1 className="text-2xl max-md:text-xl">Bikcraft</h1>
              <span className="max-md:hidden">Loja de venda de bicicletas customizadas e seguros</span>
              <a
                className="p-1 bg-[#222] block rounded-full hover:bg-[#333] max-md:text-xs"
        ...
        <div className="relative">
          <div className="absolute opacity-0 top-0 left-0 w-full h-full hover:opacity-90 hover:bg-black transition-all duration-500">
            <div className="absolute flex flex-col gap-4 text-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 font-p">
              <h1 className="text-2xl max-md:text-xl">The Mentalist</h1>
              <span className="max-md:hidden">
        ...
        <div className="relative">
          <div className="absolute opacity-0 top-0 left-0 w-full h-full hover:opacity-90 hover:bg-black transition-all duration-500">
            <div className="absolute flex flex-col gap-4 text-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 font-p">
              <h1 className="text-2xl max-md:text-xl">Conversor</h1>
              <span className="max-md:hidden">Conversor de moedas, temperaturas e medidas</span>
              <a
                className="p-1 bg-[#222] block rounded-full hover:bg-[#333] max-md:text-xs"
        ...
        <div className="relative">
          <div className="absolute opacity-0 top-0 left-0 w-full h-full hover:opacity-90 hover:bg-black transition-all duration-500">
            <div className="absolute flex flex-col gap-4 text-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 font-p">
              <h1 className="text-2xl max-md:text-xl">Super Trunfo</h1>
              <span className="max-md:hidden">
